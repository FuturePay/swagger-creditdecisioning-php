...
class ApiClient
{
     ...
     */
    public function __construct(\FuturePay\SDK\CreditDecisioning\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \FuturePay\SDK\CreditDecisioning\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\FuturePay\SDK\CreditDecisioning\ObjectSerializer::sanitizeForSerialization($postData));
        }
